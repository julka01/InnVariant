...
PLOTS = {
    ...
    'FAMILIES': {
        'Metrics': [ 'Z-diff', 'Z-min Variance', 'DCI Mod', 'DCI Expl','DCI Comp', 'Modularity', 'SAP',  "DCI Mod", "DCI Comp", "DCI Expl" ],

        'Information-based': ['MIG', 'MIG-ksg', 'DCIMIG' , 'MIG-sup', 'EDI Expl', 'EDI Comp', 'EDI Mod']
    },
...
def plot_scores(sub_parser_args):
    ...
    for format in ['png', 'eps']:
        plot_curves(plots, output_file, format=format,
                    x_label='measured factors', y_label='aggregated score',
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(PROJECT_ROOT, 'results', 'experiment_partial_factors')
    #
    # # create parser
